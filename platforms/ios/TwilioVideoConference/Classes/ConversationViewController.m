...
- (void)viewDidLoad {
    ...
    NSString *accessToken = @"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..VkEuTRyQ2lJiY4FcYYzxuCvVVq8edh0MJ4Difl7wSoM";
...
- (IBAction)closedTwilioVideo:(id)sender {
    if(self.conversation != nil){
        [self.conversation disconnect];
    }
    [self.plugin closedTwilioVideo];
}
@end
